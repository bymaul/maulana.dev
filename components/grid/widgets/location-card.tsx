...
>) {
  return (
    <button
      ...
      type="button"
      className={cn(
        'cancel-drag flex size-10 items-center justify-center rounded-full bg-white text-gray-800 shadow-md ring-2 ring-gray-200 outline-hidden transition-all duration-300 hover:bg-gray-50 hover:ring-4 hover:ring-gray-200/45 focus-visible:ring-4 focus-visible:ring-gray-200/45 dark:bg-dark-800 dark:text-white dark:ring-dark-800 dark:hover:bg-dark-700',
